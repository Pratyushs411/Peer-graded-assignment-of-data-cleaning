...
temp_train <- read.table("./Dataset/train/X_train.txt")
temp_test <- read.table("./Dataset/test/X_test.txt")
X <- rbind(temp_train, temp_test)

temp_train <- read.table("./Dataset/train/y_train.txt")
temp_test <- read.table("./Dataset/test/y_test.txt")
Y <- rbind(temp_train, temp_test)

temp_train <- read.table("./Dataset/train/subject_train.txt")
temp_test <- read.table("./Dataset/test/subject_test.txt")
